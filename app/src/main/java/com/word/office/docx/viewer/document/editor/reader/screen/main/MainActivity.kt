package com.word.office.docx.viewer.document.editor.reader.screen.main
...
import com.word.office.docx.viewer.document.editor.reader.common.BottomTab
import com.word.office.docx.viewer.document.editor.reader.common.FileTab
import com.word.office.docx.viewer.document.editor.reader.common.FunctionState
import com.word.office.docx.viewer.document.editor.reader.common.PresKey
import com.word.office.docx.viewer.document.editor.reader.common.SortState
import com.word.office.docx.viewer.document.editor.reader.databinding.ActivityMainBinding
import com.word.office.docx.viewer.document.editor.reader.dialog.AddToHomeDialog
import com.word.office.docx.viewer.document.editor.reader.dialog.DefaultReaderRequestDialog
import com.word.office.docx.viewer.document.editor.reader.dialog.SortDialog
import com.word.office.docx.viewer.document.editor.reader.model.FileModel
import com.word.office.docx.viewer.document.editor.reader.schedule.OneTimeScheduleWorker
import com.word.office.docx.viewer.document.editor.reader.screen.PolicyActivity
...
import com.word.office.docx.viewer.document.editor.reader.screen.create.BottomSheetCreatePdf
import com.word.office.docx.viewer.document.editor.reader.screen.create.CreateSuccessActivity
import com.word.office.docx.viewer.document.editor.reader.screen.file.ListAllFileFragment
import com.word.office.docx.viewer.document.editor.reader.screen.file.ListFileExcelFragment
import com.word.office.docx.viewer.document.editor.reader.screen.file.ListFilePPTFragment
import com.word.office.docx.viewer.document.editor.reader.screen.file.ListFilePdfFragment
import com.word.office.docx.viewer.document.editor.reader.screen.file.ListFileWordFragment
import com.word.office.docx.viewer.document.editor.reader.screen.func.BottomSheetFavoriteFunction
import com.word.office.docx.viewer.document.editor.reader.screen.func.BottomSheetMenuFunction
import com.word.office.docx.viewer.document.editor.reader.screen.func.BottomSheetRecentFunction
import com.word.office.docx.viewer.document.editor.reader.screen.language.LanguageActivity
import com.word.office.docx.viewer.document.editor.reader.screen.search.SelectMultipleFilesActivity
import com.word.office.docx.viewer.document.editor.reader.screen.search.SearchFileActivity
import com.word.office.docx.viewer.document.editor.reader.screen.search.SettingActivity
...
import com.word.office.docx.viewer.document.editor.reader.BuildConfig
import com.word.office.docx.viewer.document.editor.reader.dialog.DefaultReaderUninstallDialog
import com.word.office.docx.viewer.document.editor.reader.dialog.SatisfactionDialog
import com.word.office.docx.viewer.document.editor.reader.dialog.UpdateDialog
import com.word.office.docx.viewer.document.editor.reader.dialog.UpdateDownloadedDialog
import com.word.office.docx.viewer.document.editor.reader.notification.NotificationManager
import com.word.office.docx.viewer.document.editor.reader.screen.overlay.ClearDefaultReaderOverlayActivity
import com.word.office.docx.viewer.document.editor.reader.screen.iap.IapActivity
import com.word.office.docx.viewer.document.editor.reader.service.NotificationForegroundService
import com.word.office.docx.viewer.document.editor.reader.utils.AppUtils
import com.word.office.docx.viewer.document.editor.reader.utils.FileSaveManager
import com.word.office.docx.viewer.document.editor.reader.utils.FirebaseRemoteConfigUtil
import com.word.office.docx.viewer.document.editor.reader.utils.createPdf.OnPDFCreatedInterface
import com.word.office.docx.viewer.document.editor.reader.widgets.Widget1
import com.word.office.docx.viewer.document.editor.reader.widgets.Widget2
import com.word.office.docx.viewer.document.editor.reader.widgets.Widget3
...
import com.word.office.docx.viewer.document.editor.reader.dialog.ExitAppDialog
import com.word.office.docx.viewer.document.editor.reader.screen.iap.IapActivityV2
import com.word.office.docx.viewer.document.editor.reader.screen.reloadfile.FeatureRequestActivity
import com.word.office.docx.viewer.document.editor.reader.screen.reloadfile.ReloadLoadingActivity
