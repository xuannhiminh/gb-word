package com.word.office.docx.viewer.document.editor.reader
...
//                )
    ...
    private fun initLanguage() {
        if (TextUtils.isEmpty(PreferencesHelper.getString(PreferencesHelper.KEY_LANGUAGE))) {
            com.word.office.docx.viewer.document.editor.reader.screen.language.LocaleManager.getInstance(this).prefLanguage =
                com.word.office.docx.viewer.document.editor.reader.screen.language.LocaleManager.LANGUAGE_DEFAULT
            val currentLanguage = resources.configuration.locales.get(0).language
            for (i in com.word.office.docx.viewer.document.editor.reader.screen.language.LocaleManager.lstCodeLanguage.indices) {
                if (currentLanguage == com.word.office.docx.viewer.document.editor.reader.screen.language.LocaleManager.lstCodeLanguage[i]) {
