...
public class AdmobNativeNew extends RelativeLayout {
    ...
    public AdmobNativeNew(Context context) {
        super(context);
    ...
    public AdmobNativeNew(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public AdmobNativeNew(Context context, int id) {
        super(context);
    ...
    public void loadAd() {
        LogUtils.logString(AdmobNativeAdView.class, "loadAd " );
        ...
        LogUtils.logString(AdmobNativeAdView.class, "loadAd " +container+"  " + rootView+"   "+ shimmerView);
        if (container != null) {
