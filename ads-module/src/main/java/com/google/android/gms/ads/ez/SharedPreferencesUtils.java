...
public class SharedPreferencesUtils {
     ...
     * float
     **************************/
    public static void setTagFloat(Context context, String tag, float value) {
        SharedPreferences.Editor localEditor = context.getSharedPreferences(FILE_NAME, 0).edit();
        localEditor.putFloat(tag, value);
        localEditor.commit();
    }

    public static float getTagFloat(Context context, String tag) {
        return context.getSharedPreferences(FILE_NAME, 0).getFloat(tag, 0);
    }

    public static float getTagFloat(Context context, String tag, int defaultParam) {
        return context.getSharedPreferences(FILE_NAME, 0).getFloat(tag, defaultParam);
    }
}
