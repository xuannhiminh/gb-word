...
interface ZoomApi {
    ...
    @Retention(AnnotationRetention.SOURCE)
    @IntDef(
        com.ezteam.ezpdflib.widget.zoomview.Alignment.BOTTOM,
        com.ezteam.ezpdflib.widget.zoomview.Alignment.CENTER_VERTICAL,
        com.ezteam.ezpdflib.widget.zoomview.Alignment.NONE_VERTICAL,
        com.ezteam.ezpdflib.widget.zoomview.Alignment.TOP,
        com.ezteam.ezpdflib.widget.zoomview.Alignment.LEFT,
        com.ezteam.ezpdflib.widget.zoomview.Alignment.CENTER_HORIZONTAL,
        com.ezteam.ezpdflib.widget.zoomview.Alignment.NONE_HORIZONTAL,
        com.ezteam.ezpdflib.widget.zoomview.Alignment.RIGHT,
        com.ezteam.ezpdflib.widget.zoomview.Alignment.CENTER,
        com.ezteam.ezpdflib.widget.zoomview.Alignment.NONE,
        flag = true
    )
    ...
    companion object {
         ...
         */
        const val ALIGNMENT_DEFAULT = com.ezteam.ezpdflib.widget.zoomview.Alignment.CENTER
    }
}